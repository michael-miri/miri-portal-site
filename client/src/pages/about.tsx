...
export default function About() {
  return (
    <Layout>
      ...
      <section className="bg-[#09090b] border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 py-32">
            <div>
              <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">Our Mission</span>
        ...
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10 py-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">Our Values</span>
      ...
      <section className="bg-[#09090b] border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10 py-32">
          <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">Leadership</span>
      ...
      <section className="bg-[#09090b] border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10 py-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">Our Journey</span>
              <h2 className="font-heading text-[clamp(2rem,3.5vw,3rem)] font-bold text-white leading-[1.08] tracking-tight">
                Key milestones.
              </h2>
            </div>
              ...
              <div className="space-y-0">
                {milestones.map((m, idx) => (
                  <div key={m.year} className={`flex gap-8 py-8 ${idx > 0 ? "border-t border-white/[0.06]" : ""}`} data-testid={`milestone-${idx + 1}`}>
                    <span className="font-heading text-2xl font-bold text-[#0645FF]/50 shrink-0 w-20">{m.year}</span>
