          ...
          {securityPillars.map((pillar, i) => (
            ...
            >
              <div className="lg:col-span-1">
                <span className="text-[12px] text-[#C4A882]/50 font-mono">0{i + 1}</span>
              </div>
      ...
      <section className="py-32 bg-[#09090b] border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <span className="text-[13px] font-medium tracking-[0.2em] uppercase text-[#C4A882] block mb-6">Our Process</span>
              ...
              <div className="space-y-0">
                {securityProcess.map((phase, i) => (
                  <div key={phase.step} className={`flex gap-8 py-8 ${i > 0 ? "border-t border-white/[0.06]" : ""}`}>
                    <span className="text-[12px] text-[#C4A882]/50 font-mono shrink-0 pt-1">{phase.step}</span>
                    <div>
      ...
      <section className="py-32 bg-[#09090b] border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <span className="text-[13px] font-medium tracking-[0.2em] uppercase text-[#C4A882] block mb-6">Compliance</span>
              <h2 className="font-heading text-[clamp(2rem,3.5vw,3rem)] font-bold text-white leading-[1.08] tracking-tight">
