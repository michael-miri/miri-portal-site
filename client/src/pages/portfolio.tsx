            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div className="lg:col-span-1">
                  <span className="text-[11px] text-white/30 font-mono">{project.num}</span>
                </div>
                ...
                <div className="lg:col-span-5">
                  <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-white/50/80 block mb-6">Key Outcomes</span>
