          ...
          {services.map((service, i) => (
            ...
            >
              <div className="lg:col-span-1">
                <span className="text-[32px] font-bold text-[#C4A882]/50 font-mono leading-none">{service.num}</span>
              </div>
              <div className="lg:col-span-4">
                <h3 className="font-heading text-2xl font-bold text-white leading-tight">{service.title}</h3>
                <p className="mt-3 text-[17px] text-white/50 leading-relaxed">{service.desc}</p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-4">
                  {service.details.map((detail) => (
                    <div key={detail} className="flex items-start gap-3">
                      ...
                      <span className="text-[16px] text-white/50 leading-relaxed">{detail}</span>
                    </div>
                  ))}
                </div>
              </div>
