        ...
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="rounded-2xl border border-white/[0.06] bg-[#0e0e12] p-10">
                <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">Contact Info</span>
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-[#0e0e12] p-10">
                <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#0645FF] block mb-6">What to Expect</span>
