...
export function PageHeader({ label, title, description }: { label: string; title: string; description: string }) {
  return (
    <section className="pt-[140px] pb-20 bg-[#09090b]">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
        <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-white/50 block mb-6">{label}</span>
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
        <div className="border-t border-white/[0.06] pt-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            <div>
              <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-white/50 block mb-6">Next Step</span>
