...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0A0E1A]/90 backdrop-blur-xl border-b border-white/[0.06]">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden border-t border-white/[0.06] bg-[#0A0E1A]/95 backdrop-blur-xl"
          >
...
export function Footer() {
  return (
    <footer className="border-t border-white/[0.06] bg-[#0A0E1A] pt-20 pb-10">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-[14px] text-white/50">
              <li data-testid="contact-email"><a href="mailto:contact@miritechnology.com" className="hover:text-white transition-colors">contact@miritechnology.com</a></li>
            </ul>
            <div className="mt-8">
              <Link href="/contact">
                <span className="text-[13px] text-white/60 hover:text-white transition-colors inline-flex items-center gap-1.5" data-testid="link-footer-contact-cta">
